          ...
          <div class="flex flex-col md:flex-row md:items-center justify-between mb-8">
            ...
            <div class="mt-4 md:mt-0 flex items-center space-x-3">
              <button
                ...
                class="ms-button flex items-center space-x-2 shadow-sm"
              >
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right">
                      <div class="flex justify-end space-x-3">
                        <router-link
                          ...
                          class="text-[#0078d4] hover:text-[#005a9e] text-xs font-bold uppercase"
                          title="Gérer"
                        >
                          Gérer
                        </router-link>
                        <button
                          ...
                          class="text-[#0078d4] hover:text-[#005a9e]"
                          title="Détails"
                        >
                          <svg
                            class="w-4 h-4"
